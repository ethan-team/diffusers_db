...
from diffusers_db.pipelines.stable_diffusion import StableDiffusionInpaintPipeline
...
from diffusers_db.utils import deprecate, is_accelerate_available, logging
